...
if (array_filter($errors)){
    ...
    $name_1 = mysqli_real_escape_string($conn, $_GET['name']);
    $username_1 = mysqli_real_escape_string($conn, $_GET['username']);
    $password_1 = mysqli_real_escape_string($conn, $_GET['password']);
    $insert = "INSERT INTO user_details(name, username, password) VALUES('$name_1', '$username_1', '$password_1')";
...
<div class="container bg-dark">
    ...
    <div class="container-fluid bg-dark">
        ...
        <form class="d-flex">
            <div class="container">
            <button class="btn btn-danger" type="button"><a href="/form.php" class="link-light">Login</a></button>
        </div>
    </nav>
    </div>
